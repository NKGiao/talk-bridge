...
module.exports = function handleSquirrelEvent() {
  ...
  switch (squirrelEvent) {
    ...
    case '--squirrel-updated':
      ...
      console.log('[GM MeetMind] Creating shortcuts for:', exeName);
    ...
    case '--squirrel-uninstall':
      // Remove shortcuts
      console.log('[GM MeetMind] Removing shortcuts for:', exeName);
    ...
    case '--squirrel-obsolete':
      ...
      console.log('[GM MeetMind] Handling obsolete version');
      app.quit();
      return true;
  }
